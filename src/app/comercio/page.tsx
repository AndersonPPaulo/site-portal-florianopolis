...
export async function generateMetadata({
  ...
  const title = `${categoriaNome} em Florianópolis | Portal Florianópolis`;
  const description = `Explore os melhores ${categoriaNome.toLowerCase()} em Florianópolis. Descubra serviços locais, empresas e muito mais na sua região.`;
  const keywords = [
    categoriaNome,
    "comércio local",
    "serviços",
