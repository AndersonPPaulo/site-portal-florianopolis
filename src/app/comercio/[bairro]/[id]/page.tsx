...
export async function generateMetadata({
  ...
  if (!comercio) {
    return {
      title: "Comércio não encontrado - Portal Florianópolis",
  ...
  const imageUrl =
    ...
    "https://portalflorianopolis.com.br/images/default-og-image.jpg";
  ...
  return {
    ...
    description:
      ...
      "Informações detalhadas sobre este comércio em Florianópolis você vê aqui!.",
    openGraph: {
      title: `${capitalize(comercio.name)}, ${capitalize(
        bairro,
      )} - ${capitalize(comercio.city)} | Portal Florianópolis`,
      description:
        comercio.description ||
        "Descubra mais sobre este comércio em Florianópolis.",
      url: `https://portalflorianopolis.com.br/comercio/${bairro}/${id}`,
    ...
    twitter: {
      ...
      description:
        comercio.description ||
        "Informações detalhadas sobre este comércio em Florianópolis.",
      images: [imageUrl],
    },
  };
}
